    ...
    <div className="min-h-screen bg-[#030E4F] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col gap-16">
          ...
          {/* Stats Section */}
          <section className="py-16 bg-[#020B3F] rounded-2xl">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <HoverAnimation type="lift">
                    <Card className="bg-[#020B3F] border-[#F49F1C]/20">
          ...
          <section className="py-20">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <HoverAnimation type="lift">
                <Card className="bg-[#020B3F] border-[#F49F1C]/20 h-full">
          ...
          {/* Careers CTA */}
          <section className="bg-gradient-to-r from-[#030E4F] via-[#1E3A8A] to-[#F49F1C]/20 rounded-2xl p-8 text-center">
            <FadeIn>
